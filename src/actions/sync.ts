...
import { LOAD_TODOS, UPDATE_TODO, SELECT_TODO, CLEAR_LOADED, TOGGLE_WAITING } from './types';
...
export const toggleWaiting = actionCreator<null, TOGGLE_WAITING>(TOGGLE_WAITING);